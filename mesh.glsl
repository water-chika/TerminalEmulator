...
void main(){
    ...
    uint vertex_start_index = 3*gl_LocalInvocationIndex;
    ...
    gl_PrimitiveTriangleIndicesEXT[gl_LocalInvocationIndex] = uvec3(vertex_start_index,vertex_start_index+1,vertex_start_index+2);
